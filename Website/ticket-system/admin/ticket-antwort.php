...
if($rang == "admin") {
    ...
    $msg = "<span style='color:#AA0000' class='font'>Admin</span>";
  
  }elseif($rang == "supporter") {
  
    $msg = "<span style='color:#AA0000' class='font'>Supporter</span>";
      
  }elseif($rang == "moderator") {
  
    $msg = "<span style='color:#AA0000' class='font'>Moderator</span>";
...
<div class="jumbotron font shadow-lg p-3 mb-5 bg-white rounded border border-dark">
  <h2 class="display-4 text-primary"><center>Antworten</center></h2>
  <br>
  <br>
  ...
  <div class="collapse navbar-collapse" id="navbarSupportedContent">
    <ul class="navbar-nav mr-auto">
      ...
      <li class="nav-item active">
        <a class="nav-link" href="ticket-antwort.php">Tickets antworten<span class="sr-only">(current)</span></a>
      </li>
      <li class="nav-item">
  ...
  <br>
  <hr>
  <center><p class="font"><?php echo "Hallo ".$msg." | ".$name ?></p></center>
  <hr>
  <br>
  <form class="font" method="post" action="manager/antwortManager.php">
     <div class="form-row">
    ...
    <div class="form-group col-md-12">
     ...
     <button type="submit" class="btn btn-dark btn-lg btn-block" name="submit">Abschicken</button>
     </div>
