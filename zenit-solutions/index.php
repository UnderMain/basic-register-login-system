...
<div id="content">
  ...
  <br>
    ...
    <?php echo $msg;?>
    <center><img src="assets/img/logo_small.png" class="rounded"></center>
    <hr>
    <center><div class="border w-75 p-3 rounded">
    <h2 class="text-white">WER WIR SIND</h2>
    ...
    <div class="container">
        ...
        <h5 class="text-white">Das Team von Zenit Solution Studios kreiert</h5>
        <h5 class="text-white">deine Persönliche Website nach deinen</h5>
        <h5 class="text-white">Vorstellungen oder überarbeiten deine alte Website!</h5>
    </div>
    </div>  
    </center>
    </div></center>
    ...
    <center><div class="border w-75 p-3 rounded">
    <h2 class="text-white">KONTAKT-FORMULAR</h2>
  <div class="container ">
  <div class="container">
