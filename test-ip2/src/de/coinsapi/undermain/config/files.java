...
import de.coinsapi.undermain.main.Main;
...
public class files
 {
   ...
   public void createDefaultLizenz() {
       try {
      File File = new File("plugins/CoinsAPI/", "Lizenz.yml");
   ...
   public void createConfig() {
      ...
      cfg.addDefault("Settings.Kickgrund", "Du bist das erste mal gejoint! Dein Spielerprofil wurde angelegt!");
   ...
   public void loadConfig() {
     try {
      File File = new File("plugins/CoinsAPI/", "config.yml");
       ...
       getObject_config.put("Kick", "" +cfg.get("Settings.Kickgrund"));
